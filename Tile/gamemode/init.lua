...
AddCSLuaFile("tilescoreboard.lua")
AddCSLuaFile("tilescoreboard/playeroption.lua")
AddCSLuaFile("tilescoreboard/playerrow.lua")
AddCSLuaFile("tilescoreboard/scoreboard.lua")
AddCSLuaFile("tilescoreboard/aboutbutton.lua")
if (SERVER) then
